...
import ETHHAMPriceFeedOracle from "../build/contracts/ETHHAMPriceFeedOracle.json";
...
const oracleContract = new web3.eth.Contract(
  ETHHAMPriceFeedOracle.abi, // Contract ABI
  ETHHAMPriceFeedOracle.networks[netId].address // Contract address
);
